...
char *colors[][2] = {
	/*               fg         bg       */
	[SchemeNorm] = { "#e4cbb3", "#1b110e" },
	[SchemeSel]  = { "#1b110e", "#f99666" },
	[SchemeOut]  = { "#e4cbb3", "#1b110e" },
	#if BORDER_PATCH
	...
	#endif // MORECOLOR_PATCH
	#if HIGHLIGHT_PATCH || FUZZYHIGHLIGHT_PATCH
	[SchemeSelHighlight]  = { "#1b110e", "#f99666" },
	[SchemeNormHighlight] = { "#e4cbb3", "#222222" },
