...
static const char *BAR_FONT[] = { "Nsxiv.bar.font",            "Fira Code-12" };
...
static const float zoom_levels[] = {
   12.5,   25.0,   50.0,   75.0,
	...
	800.0, 1000.0, 1600.0, 3000.0,
};

/* default slideshow delay (in sec, overwritten via -S option): */
static const int SLIDESHOW_DELAY = 2;
...
static const int PAN_FRACTION = 15;
 ...
 * higher memory usage.
 */
static const int CACHE_SIZE_MEM_PERCENTAGE = 5;          /* use num% of total memory for cache */
static const int CACHE_SIZE_LIMIT = 512 * 1024 * 1024;   /* but not above numMiB */
...
static const int thumb_sizes[] = { 110, 125, 150, 175, 200, 205, 250, 300, 350, 500};
